    ...
    <div className="row">
      ...
      <div className="eight columns main-col">
        ...
        <p>
          ...
          More than 18 years of industry experience in different scale companies in various roles:
          engineer, team/tech lead, manager, consultant, trainer. My main areas of interest are data engineering,
          software development, machine learning, and quality assurance. The main languages (tech stacks) are Scala and Python.
